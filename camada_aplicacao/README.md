...
Na figura a seguir, podemos compreender melhor o funcionamento da hierarquia do DNS:
...
* ```python3 smtp.py <DOMÍNIO> <ENDERECO_REMETENTE> <ENDERECO_DESTINATARIO>```
